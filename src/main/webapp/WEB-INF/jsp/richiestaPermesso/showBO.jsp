			  ...
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<!-- info Dipendente, Solo quando si è in BO -->
					    ...
					    <div class='card-footer'>
					    	<div>
						    	<form method="post" action="${pageContext.request.contextPath}/richiestaPermesso/approva">
						    		<input type="hidden" value="${show_richiesta_attr.id}" name="idRichiesta">
						    		<input type="submit" value="approva">
						    	</form>
					    	</div>
					    	<div>
						    	<form method="post" action="${pageContext.request.contextPath}/richiestaPermesso/rifiuta">
						    		<input type="hidden" value="${show_richiesta_attr.id}" name="idRichiesta">
						    		<input type="submit" value="rifuta">
						    	</form>
					    	</div>
					        <a href="${pageContext.request.contextPath}/richiestaPermesso/listBO" class='btn btn-outline-secondary' style='width:80px'>
