							...
							<form:form enctype="multipart/form-data" modelAttribute="insert_richiesta_attr" method="post" action="${pageContext.request.contextPath}/richiestaPermesso/save" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6 " id="codiceCertificato">
									...
									<spring:bind path="codiceCertificato">
										<input type="text" name="codiceCertificato" id="codiceCertificato" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice certificato" value="${insert_richiesta_attr.codiceCertificato }" >
									</spring:bind>
								...
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDateInizio" type='date' value='${insert_richiesta_attr.dataInizio}' />
								<div class="col-md-3">
